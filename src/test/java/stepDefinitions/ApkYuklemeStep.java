...
public class ApkYuklemeStep {
    ...
    @Given("Kulanici gerekli kurulumlari yaparak {string} yukleme islemi gerceklestirir")
    public void kulaniciGerekliKurulumlariYaparakYuklemeIslemiGerceklestirir(String apk) throws MalformedURLException {
